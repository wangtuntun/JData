...
#------------------------------------------------------------读取文件信息------------------------------------------------#
    ...
    # filtered_user=pd.read_csv(data_dir+"JData_User2_active_filtered3.csv")
    ...
    # # filtered_userid = filtered_userid[0:10000]
    # filtered_userid = filtered_userid[30000:len(filtered_userid)]
