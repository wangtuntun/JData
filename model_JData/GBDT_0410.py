...
def run_demo(n_estimators,max_depth,oob_score,random_state):
    ...
    feature_save_path = dealed_data_dir + "训练数据.csv"
    ...
    pd.DataFrame(pre_1_list).to_csv(dealed_data_dir + "balanced_gbdt_0410_predict_1.csv")
    ...
    result_path=dealed_data_dir + "balanced_gbdt_0410_predict_info.csv"
