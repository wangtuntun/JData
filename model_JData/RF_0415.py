...
train_data_path=dealed_data_dir + "all_feature_01_label_100_formatted" #1:10

pre_data_path=dealed_data_dir + "predict_0415_data_2_steps_formatted.csv"
pair_path = dealed_data_dir + "predict_0415_data_2_steps.csv"

result_path= dealed_data_dir + "rf_pre_0415_info_2_steps.csv"
pre_pair_path= dealed_data_dir + "rf_pre_0415_info_pair_2_steps.csv"
